...
public:
    ...
    QLabel *error_add;
    QPlainTextEdit *questionLineEdit;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainStack->setGeometry(QRect(0, 0, 360, 640));
        ...
        playBtn->setGeometry(QRect(80, 150, 211, 41));
        QFont font;
        font.setFamilies({QString::fromUtf8("Poppins Black")});
        font.setPointSize(14);
        font.setBold(true);
        playBtn->setFont(font);
        playBtn->setStyleSheet(QString::fromUtf8("background:#9754CB;\n"
"color: white;"));
        lbBtn = new QPushButton(Startpg);
        lbBtn->setObjectName("lbBtn");
        lbBtn->setGeometry(QRect(80, 200, 211, 31));
        QFont font1;
...
"color: white"));
        ...
        aboutusBtn->setGeometry(QRect(80, 280, 211, 31));
        QFont font2;
...
"color: white"));
        ...
        customBtn->setGeometry(QRect(80, 240, 211, 31));
        customBtn->setFont(font2);
        customBtn->setStyleSheet(QString::fromUtf8("background:#9754CB;\n"
"color: white"));
        ...
        diffLbl->setGeometry(QRect(60, 160, 91, 20));
        QFont font3;
        ...
        qnLbl->setGeometry(QRect(60, 220, 161, 21));
        qnLbl->setFont(font3);
...
"color: white"));
        ...
        catLbl->setGeometry(QRect(50, 100, 161, 21));
...
";color: rgba(255,255,255,0.7)"));
        ...
        diffStacked->setGeometry(QRect(10, 230, 341, 191));
        ...
        trueBtn->setGeometry(QRect(70, 50, 201, 31));
        QFont font5;
...
"color:white;"));
        ...
        falseBtn->setGeometry(QRect(70, 100, 201, 31));
...
"color:white;"));
        ...
        aBtn->setGeometry(QRect(60, 20, 221, 31));
        QFont font6;
        ...
        bBtn->setGeometry(QRect(60, 60, 221, 31));
        bBtn->setFont(font5);
        ...
        cBtn->setGeometry(QRect(60, 100, 221, 31));
        cBtn->setFont(font5);
        ...
        dbtn->setGeometry(QRect(60, 140, 221, 31));
        dbtn->setFont(font5);
        ...
        identiLine->setGeometry(QRect(20, 30, 301, 111));
...
"color: white"));
        ...
        pauseBtn->setGeometry(QRect(20, 20, 61, 21));
...
"color: white"));
        ...
        scoreLbl->setGeometry(QRect(260, 20, 63, 20));
        ...
        scoreNum->setGeometry(QRect(310, 20, 51, 20));
        ...
        timeLbl->setGeometry(QRect(140, 60, 41, 14));
        ...
        categoryLbl->setGeometry(QRect(150, 30, 71, 20));
...
""));
        ...
        quesNumLbl->setGeometry(QRect(40, 200, 61, 16));
...
"color: white"));
        ...
        resueBtn->setGeometry(QRect(110, 130, 161, 41));
...
"color:white"));
        ...
        retryBtn->setGeometry(QRect(110, 180, 161, 41));
...
"color:white"));
        ...
        menuBtn->setGeometry(QRect(110, 230, 161, 41));
        menuBtn->setFont(font3);
        menuBtn->setStyleSheet(QString::fromUtf8("background: #9754cb;\n"
"color:white"));
        ...
        name_inp->setGeometry(QRect(130, 270, 131, 31));
...
"color: white"));
        remarksLbl->setAlignment(Qt::AlignCenter);
...
"color: white"));
        ...
        error_msg_l->setStyleSheet(QString::fromUtf8("color:white;"));
...
"color: white"));
        ...
        userLbl->setGeometry(QRect(100, 150, 111, 20));
        ...
        error_msg->setStyleSheet(QString::fromUtf8("color:white;"));
        ...
        sign_sec->setAutoFillBackground(false);
...
"color: white"));
        ...
        categorylineEdit->setStyleSheet(QString::fromUtf8("color:white;"));
        ...
        namelineEdit->setStyleSheet(QString::fromUtf8("color:white"));
        ...
        noteTextbox->setGeometry(QRect(80, 110, 231, 41));
        noteTextbox->setFocusPolicy(Qt::StrongFocus);
        noteTextbox->setStyleSheet(QString::fromUtf8("color:white"));
        noteTextbox->setReadOnly(false);
        addnoteLbl = new QLabel(addStack);
        addnoteLbl->setObjectName("addnoteLbl");
        addnoteLbl->setGeometry(QRect(10, 100, 58, 26));
        ...
        onadderror->setGeometry(QRect(10, 160, 101, 20));
        ...
        editList->setGeometry(QRect(100, 10, 121, 211));
        ...
        cstmbackBtn->setGeometry(QRect(20, 20, 91, 21));
...
"color: white"));
        ...
        editIndex->setGeometry(QRect(200, 60, 141, 29));
...
"color: white"));
        ...
        addIndex->setGeometry(QRect(30, 60, 141, 29));
...
"color: white"));
        ...
        addcatLbl->setGeometry(QRect(20, 40, 91, 20));
        ...
        nameLbl_4->setGeometry(QRect(120, 40, 131, 20));
        ...
        qnoLbl->setGeometry(QRect(250, 30, 91, 20));
        ...
        quesText->setGeometry(QRect(20, 130, 81, 20));
        quesText->setFont(font3);
        quesText->setStyleSheet(QString::fromUtf8("color:white"));
        optionCBox = new QStackedWidget(addpg);
        optionCBox->setObjectName("optionCBox");
        optionCBox->setGeometry(QRect(20, 270, 321, 101));
...
"color: white"));
        ...
        addBtn->setGeometry(QRect(140, 410, 93, 29));
        ...
        difficultyCBox->setGeometry(QRect(70, 90, 231, 26));
        ...
        addSaveBtn->setGeometry(QRect(10, 10, 81, 21));
        ...
        error_add->setGeometry(QRect(30, 380, 311, 31));
        error_add->setFont(font5);
        error_add->setStyleSheet(QString::fromUtf8("color:white"));
        questionLineEdit = new QPlainTextEdit(addpg);
        questionLineEdit->setObjectName("questionLineEdit");
        questionLineEdit->setGeometry(QRect(20, 170, 321, 71));
...
"color: black;"));
        ...
        lbText->setStyleSheet(QString::fromUtf8("color:white;"));
        ...
        lbText_2->setGeometry(QRect(50, 210, 231, 231));
...
"color: white"));
        ...
        tableLead->setHorizontalHeaderItem(0, __qtablewidgetitem1);
        QTableWidgetItem *__qtablewidgetitem2 = new QTableWidgetItem();
        tableLead->setHorizontalHeaderItem(1, __qtablewidgetitem2);
        tableLead->setObjectName("tableLead");
        tableLead->setGeometry(QRect(50, 210, 251, 241));
        tableLead->setStyleSheet(QString::fromUtf8("color:white;"));
        cat_combo = new QComboBox(leaderboardspg);
        cat_combo->setObjectName("cat_combo");
        cat_combo->setGeometry(QRect(130, 77, 181, 31));
        cat_combo->setStyleSheet(QString::fromUtf8("color:white;"));
        catlbl = new QLabel(leaderboardspg);
        catlbl->setObjectName("catlbl");
        catlbl->setGeometry(QRect(30, 80, 63, 20));
        catlbl->setAutoFillBackground(false);
        catlbl->setStyleSheet(QString::fromUtf8("color:white;"));
        diflbl = new QLabel(leaderboardspg);
        diflbl->setObjectName("diflbl");
        diflbl->setGeometry(QRect(30, 120, 63, 20));
        diflbl->setStyleSheet(QString::fromUtf8("color:white;"));
        diif_combo = new QComboBox(leaderboardspg);
        diif_combo->setObjectName("diif_combo");
        diif_combo->setGeometry(QRect(130, 117, 181, 31));
        diif_combo->setStyleSheet(QString::fromUtf8("color:white;"));
        qnumlbl = new QLabel(leaderboardspg);
        qnumlbl->setObjectName("qnumlbl");
        qnumlbl->setGeometry(QRect(30, 160, 121, 21));
        qnumlbl->setStyleSheet(QString::fromUtf8("color:white;"));
        q_num_combo = new QComboBox(leaderboardspg);
        q_num_combo->setObjectName("q_num_combo");
        q_num_combo->setGeometry(QRect(160, 157, 151, 31));
        q_num_combo->setStyleSheet(QString::fromUtf8("color:white;"));
        pushButton = new QPushButton(leaderboardspg);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(20, 10, 83, 29));
...
"color: white"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        editIndex->setText(QCoreApplication::translate("MainWindow", "View", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem1 = tableLead->horizontalHeaderItem(0);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("MainWindow", "name", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableLead->horizontalHeaderItem(1);
